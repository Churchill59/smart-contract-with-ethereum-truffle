...
contract StarNotary is ERC721 {
    ...
    string public constant TokenName = "Token Name Zoulou";
    string public constant TokenSymbol = "TNZ";

    function lookUptokenIdToStarInfo(uint256 _tokenId) public view returns(string memory) {
        return tokenIdToStarInfo[_tokenId].name;
    }

    function exchangeStars(address _user1, uint256 _tokenId1, address _user2, uint256 _tokenId2) public returns (bool) {
